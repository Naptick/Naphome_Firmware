...
#ifndef CONFIG_AWS_IOT_MQTT_HOST
#define CONFIG_AWS_IOT_MQTT_HOST "example.amazonaws.com"
#endif

#ifndef CONFIG_AWS_IOT_MQTT_PORT
#define CONFIG_AWS_IOT_MQTT_PORT 8883
#endif

#ifndef CONFIG_AWS_IOT_MQTT_TX_BUF_LEN
#define CONFIG_AWS_IOT_MQTT_TX_BUF_LEN 2048
#endif

#ifndef CONFIG_AWS_IOT_MQTT_RX_BUF_LEN
#define CONFIG_AWS_IOT_MQTT_RX_BUF_LEN 2048
#endif

#ifndef CONFIG_AWS_IOT_MQTT_NUM_SUBSCRIBE_HANDLERS
#define CONFIG_AWS_IOT_MQTT_NUM_SUBSCRIBE_HANDLERS 4
#endif

#ifndef CONFIG_AWS_IOT_SHADOW_MAX_SIZE_OF_THING_NAME
#define CONFIG_AWS_IOT_SHADOW_MAX_SIZE_OF_THING_NAME 32
#endif

#ifndef CONFIG_AWS_IOT_SHADOW_MAX_SHADOW_TOPIC_LENGTH_WITHOUT_THINGNAME
#define CONFIG_AWS_IOT_SHADOW_MAX_SHADOW_TOPIC_LENGTH_WITHOUT_THINGNAME 60
#endif

#ifndef CONFIG_AWS_IOT_SHADOW_MAX_SIZE_OF_RX_BUFFER
#define CONFIG_AWS_IOT_SHADOW_MAX_SIZE_OF_RX_BUFFER 2048
#endif

#ifndef CONFIG_AWS_IOT_SHADOW_MAX_SIMULTANEOUS_ACKS
#define CONFIG_AWS_IOT_SHADOW_MAX_SIMULTANEOUS_ACKS 5
#endif

#ifndef CONFIG_AWS_IOT_SHADOW_MAX_SIMULTANEOUS_THINGNAMES
#define CONFIG_AWS_IOT_SHADOW_MAX_SIMULTANEOUS_THINGNAMES 1
#endif

#ifndef CONFIG_AWS_IOT_SHADOW_MAX_JSON_TOKEN_EXPECTED
#define CONFIG_AWS_IOT_SHADOW_MAX_JSON_TOKEN_EXPECTED 64
#endif

#ifndef CONFIG_AWS_IOT_MQTT_MIN_RECONNECT_WAIT_INTERVAL
#define CONFIG_AWS_IOT_MQTT_MIN_RECONNECT_WAIT_INTERVAL 1
#endif

#ifndef CONFIG_AWS_IOT_MQTT_MAX_RECONNECT_WAIT_INTERVAL
#define CONFIG_AWS_IOT_MQTT_MAX_RECONNECT_WAIT_INTERVAL 128
#endif
